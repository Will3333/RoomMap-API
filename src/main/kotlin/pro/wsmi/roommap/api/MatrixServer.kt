...
)
{
        ...
        fun update(dbConn: Database, name: String = this.name, apiUrl: URL = this.apiUrl, updateFreq: ULong = this.updateFreq, disabled: Boolean = this.disabled, tryBeforeDisabling: UInt = this.tryBeforeDisabling, rooms: List<MatrixRoom> = this.rooms) : Result<MatrixServer>
        {
        ...
        {
                @ExperimentalUnsignedTypes
                fun new(dbConn: Database, name: String, apiUrl: URL, updateFreq: ULong = 3600000u, disabled: Boolean = false, tryBeforeDisabling: UInt = 3u) : Result<MatrixServer>
                {
                        val serverId = try {
                                transaction(dbConn) {
                ...
                @ExperimentalUnsignedTypes
                fun getAllServers(dbConn: Database, notDisabled: Boolean = false) : Result<List<MatrixServer>>
                {
                        try {
